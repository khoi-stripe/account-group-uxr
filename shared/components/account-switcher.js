...
class AccountSwitcher {
                  ...
                  accountsHtml += sortedAccounts.map((account, index) => {
                    ...
                    if (account.isAggregate) {
                      ...
                      <div class="account-details">
                          ...
                          ${isActive ? '<div class="account-check"><img src="shared/svgs/checkCircleFilled.svg?v=6" width="12" height="12" alt="Selected" style="filter: brightness(0) saturate(100%) invert(54%) sepia(8%) saturate(1157%) hue-rotate(169deg) brightness(95%) contrast(91%);"></div>' : ''}
                    </button>
                  `;
  ...
  close() {
    ...
    // Note: No need to update popover manager state since it's handled by the manager
  ...
  updateDropdownSelection(selectedAccountId) {
    ...
    accountItems.forEach(item => {
      ...
      if (accountId === selectedAccountId) {
        ...
        const checkMarkHtml = `
          <div class="account-check">
            <img src="shared/svgs/checkCircleFilled.svg?v=6" width="12" height="12" alt="Selected" style="filter: brightness(0) saturate(100%) invert(54%) sepia(8%) saturate(1157%) hue-rotate(169deg) brightness(95%) contrast(91%);">
          </div>
        `;
